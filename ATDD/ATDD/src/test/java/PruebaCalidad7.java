...
//Entrar desde el Home al algoritmo Northwest y cambia el primer valor de la tabla

public class PruebaCalidad7{
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        tabla1.clear();
        tabla1.sendKeys("60");
        Assert.assertEquals(tabla1.getAttribute("value"), "60", "El campo debe ser '60'");
        System.out.println("El campo es correcto mostrando "+ tabla1.getAttribute("value"));
