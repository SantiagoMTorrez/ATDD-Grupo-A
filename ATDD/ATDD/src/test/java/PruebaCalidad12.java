...
//Entrar desde el Home al algoritmo Sorts, ingresar datos manualmente y comprobar el dato maximo registrado es correcto

public class PruebaCalidad12{
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        //5. Buscar el dato maximo registrado
        WebElement maximo = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div/div[2]/main/aside/div/div/div[3]/div/div[3]/div/span")   
        );
        Assert.assertTrue(maximo.isDisplayed(), "El dato maximo debe estar visible");
        System.out.println("El dato maximo fue encontrada y visible");
        System.out.println("El dato maximo es correcto: " + maximo.getText());
        Assert.assertEquals(maximo.getText(), "89", "El dato maximo debe ser '89'");
