...
//Entrar desde el Home al algoritmo Northwest y comprobar que no se puede poner un valor no numérico en la tabla

public class PruebaCalidad8{
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        // 2. Presionar el botón que lleva a la pagina de Northwest
        ...
        // 3. Buscar primer elemento de la tabla 
        WebElement tabla1 = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div[2]/main/div/div/div[2]/table/tbody/tr[1]/td[1]/input")
        );
        Assert.assertTrue(tabla1.isDisplayed(), "El campo de texto debe estar visible");
        System.out.println("El campo de texto fue encontrado y visible");
        tabla1.clear();
        tabla1.sendKeys("abc");
        Assert.assertEquals(tabla1.getAttribute("value"), "", "El campo debe ser vacio");
        System.out.println("El campo es correcto mostrando un valor vacio");
