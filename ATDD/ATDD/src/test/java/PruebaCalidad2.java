...
//Entrar desde el Home al algoritmo Johnson, buscar el boton circulo e insertar un nodo

public class PruebaCalidad2 {
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        Assert.assertTrue(insertarNodo.isDisplayed(), "El boton insertar nodo debe estar visible");
