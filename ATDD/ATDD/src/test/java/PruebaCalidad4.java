...
//Entrar desde el Home al algoritmo de Kruskal, buscar el boton de ovalo, insertar un nodo y cambiar el nombre

public class PruebaCalidad4 {
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        // 2. Presionar el botón que lleva a la pagina de kruskal
        WebElement botonNavegacion = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div/div/div/nav/div/button[7]")
        );
        ...
        // 3. Buscar y verificar el boton de ovalo en la nueva página
        WebElement elementoSVG = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div[2]/main/aside/div[2]/div[1]/div/button[2]/span")
        );
        ...
        System.out.println("El boton ovalo fue encontrado y visible");
        ...
        //5. Encontrar elemento de texto del nodo
        WebElement insertarNodo = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div[2]/main/div/input")
        ); 
        Assert.assertTrue(insertarNodo.isDisplayed(), "El campo de texto debe estar visible");

        insertarNodo.click();
        insertarNodo.clear();
        insertarNodo.sendKeys("PRUEBA");
        Assert.assertEquals(insertarNodo.getAttribute("value"), "PRUEBA", "El nombre del nodo debe ser 'PRUEBA'");
