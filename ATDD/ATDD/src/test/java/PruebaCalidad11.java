...
//Entrar desde el Home al algoritmo Sorts, ingresar datos manualmente y comprobar el dato minimo registrado es correcto

public class PruebaCalidad11{
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        //5. Buscar el dato minimo registrado
        WebElement minimo = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div/div[2]/main/aside/div/div/div[3]/div/div[2]/div/span")   
        );
        Assert.assertTrue(minimo.isDisplayed(), "El dato minimo debe estar visible");
        System.out.println("El dato minimo fue encontrada y visible");
        System.out.println("El dato minimo es correcto: " + minimo.getText());
        Assert.assertEquals(minimo.getText(), "2", "El dato minimo debe ser '2'");
