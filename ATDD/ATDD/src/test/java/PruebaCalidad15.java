...
//Entrar desde el Home al algoritmo Northwest y comprobar que resuelva en dos iteraciones el algoritmo correctamente en minimizacion

public class PruebaCalidad15{
    ...
    public void verificarNavegacionYElementoSVG() {
        ...
        //6. Verificar el numero de iteraciones
        WebElement botonIteracion = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div[2]/main/div/div[2]/div/div[1]/div[2]/button[2]")
        );
        Assert.assertTrue(botonIteracion.isDisplayed(), "El boton de iteracion debe estar visible");
        botonIteracion.click();
        System.out.println("Botón de iteracion clickeado");

        WebElement numeroIteraciones = driver.findElement(
            By.xpath("//*[@id=\"app\"]/div[2]/main/div/div[2]/div/div[3]/div[2]/div[2]/span[2]")
        );
        Assert.assertTrue(numeroIteraciones.isDisplayed(), "El costo total debe estar visible");
        System.out.println("El costo total fue encontrado y visible");
        System.out.println("El costo total es correcto: " + numeroIteraciones.getText());
        Assert.assertEquals(numeroIteraciones.getText(), "2", "El costo total debe ser '2'");
